            ...
            <div class="col-md-10 col-sm-11 display-table-cell v-align">
                ...
                <div class="user-dashboard">
                    <div class="container col-sm-12">
                            ...
                            <div class="col-md-11">
                                <div class="panel panel-primary">
                                    <div class="panel-heading" style="display: flex; align-items: center; flex-wrap: wrap;">
                                        <h2 class="text-center" style="flex-basis: 100%;">Reporte Venta hechas en el mes de Mayo</h2>
                                        <div style="width: 100%;">
                                    ...
                                    <table class="table table-hover" id="dev-table">
                                        ...
                                        <tbody>
                                            <?php
                                                include('conecta.php');
                                                $query = "SELECT * FROM view_venta WHERE fecha BETWEEN '2023-05-01' AND '2023-05-31'";
                        ...
                        <a href="ReporteV1-pdf.php">Exportar PDF</a>
                        <b>|</b>
                        <a href="ReporteV1-excel.php">Exportar EXEL</a>
                        <b>|</b>
                        <a href="ReporteV1-csv.php">Exportar CSV</a>
                        <b>|</b>
                        <a href="ReporteV1-json.php">Exportar JSON</a>
                        <b>|</b>
                        <a href="ReporteV1-xsl.php">Exportar XML</a>
                        <div class="row">
                            <div class="col-md-11">
                                <div class="panel panel-primary">
                                    <div class="panel-heading" style="display: flex; align-items: center; flex-wrap: wrap;">
                                        <h2 class="text-center" style="flex-basis: 100%;">Reporte Venta desde el 2019 hasta el 2022</h2>
                                        <div style="width: 100%;">
                                            <span class="clickable filter pull-right larger-span" data-toggle="tooltip" title="Toggle table filter" data-container="body">
                                                <i class="glyphicon glyphicon-filter larger-icon"></i>
                                            </span>
                                    ...
                                    <table class="table table-hover" id="dev-table">
                                        ...
                                        <tbody>
                                            <?php
                                                include('conecta.php');
                                                $query = "SELECT * FROM view_venta2 WHERE fecha BETWEEN '2019-01-01' AND '2022-12-31'";
                                                $result = mysqli_query($conexion, $query);
                                                while($row = mysqli_fetch_assoc($result)){
                                                    echo "
                                                    <tr class='larger-row'>
                        ...
                        <a href="ReporteV2-pdf.php">Exportar PDF</a>
                        <b>|</b>
                        <a href="ReporteV2-excel.php">Exportar EXEL</a>
                        <b>|</b>
                        <a href="ReporteV2-csv.php">Exportar CSV</a>
                        <b>|</b>
                        <a href="ReporteV2-json.php">Exportar JSON</a>
                        <b>|</b>
                        <a href="ReporteV2-xsl.php">Exportar XML</a>
                        <div class="row">
                            <div class="col-md-11">
                                <div class="panel panel-primary">
                                    <div class="panel-heading" style="display: flex; align-items: center; flex-wrap: wrap;">
                                        <h2 class="text-center" style="flex-basis: 100%;">Reporte Venta durante el año 2023</h2>
                                        <div style="width: 100%;">
                                            <span class="clickable filter pull-right larger-span" data-toggle="tooltip" title="Toggle table filter" data-container="body">
                                                <i class="glyphicon glyphicon-filter larger-icon"></i>
                                            </span>
                                    ...
                                    <table class="table table-hover" id="dev-table">
                                        ...
                                        <tbody>
                                            <?php
                                                include('conecta.php');
                                                $query = "SELECT * FROM view_venta3 WHERE fecha BETWEEN '2023-01-01' AND '2023-12-31'";
                                                $result = mysqli_query($conexion, $query);
                                                while($row = mysqli_fetch_assoc($result)){
                                                    echo "
                                                    <tr class='larger-row'>
                        ...
                        <a href="ReporteV3-pdf.php">Exportar PDF</a>
                        <b>|</b>
                        <a href="ReporteV3-excel.php">Exportar EXEL</a>
                        <b>|</b>
                        <a href="ReporteV3-csv.php">Exportar CSV</a>
                        <b>|</b>
                        <a href="ReporteV3-json.php">Exportar JSON</a>
                        <b>|</b>
                        <a href="ReporteV3-xsl.php">Exportar XML</a>
                    </div>
                </div>
            </div>
        </div>
