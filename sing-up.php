      ...
      <div class="row gx-lg-5 align-items-center mb-5">
        <div class="col-lg-6 mb-5 mb-lg-0" style="z-index: 10">
          <h1 class="my-5 display-5 fw-bold ls-tight" style="color: hsl(218, 81%, 95%)">
            Comienza a registrarte <br />
            <span style="color: hsl(218, 81%, 75%)">Crea tu cuenta y comienza a abarcar nuevas experiencias</span>
          </h1>
              ...
              <form action="singup.php" method="post">
                ...
                <?php
                  ...
                  if ($_GET["Exist"] != 'vacio') {
                    ...
                    <!-- Label verification -->
                    <div>
                        <p for="form3Example5" class="text-danger">
                          *<?php echo $texto; ?>
                        </p>
                    </div>
                    ';
