        ...
        <div class="row display-table-row">
            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                ...
                <div class="navi">
                    ...
                    <li class="active"><a href="#"><i class="fa fa-tasks" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Cliente</span></a></li>
            ...
            <div class="col-md-10 col-sm-11 display-table-cell v-align">
                ...
                <div class="user-dashboard">
                    <div class="container col-sm-12">
                            ...
                            <div class="col-md-11">
                                <div class="panel panel-primary">
                                    <div class="panel-heading" style="display: flex; align-items: center; flex-wrap: wrap;">
                                        <h2 class="text-center" style="flex-basis: 100%;">Cliente</h2>
                                        <div style="width: 100%;">
                                        <?php 
                                        echo "
                                            <button class='btn btn-success' type='button' onclick='window.location.href = `clienteAdd.php?user=$user`' style='margin-bottom: 10px';>Agregar</button>";
                                        ?>
                                    ...
                                    <table class="table table-hover" id="dev-table">
                                        ...
                                        <tbody>
                                            <?php
                                                include('conecta.php');
                                                $query = "SELECT `idCliente`, `nombre`, `apPaterno`, `apMaterno`, `direccion`, `telefono` FROM `cliente` WHERE `estatus` = 1";
                                                    ...
                                                    <tr class='larger-row'>
                                                        ...
                                                        <td>
                                                            <form action='clienteEditar.php' method='post'>
                                                                <input type='hidden' name='editar' id='editar' value='".$row['idCliente']."'>
                                                        ...
                                                        <td>
                                                            <form action='clienteEliminar.php' method='post'>
                                                                <input type='hidden' name='borrar' value='".$row['idCliente']."'>
                                                                <input type='hidden' name='user' id='user' value='".$user."'>
                        ...
                        <a href="cliente-pdf.php">Exportar PDF</a>
                        <b>|</b>
                        <a href="cliente-excel.php">Exportar EXCEL</a>
                        <b>|</b>
                        <a href="cliente-csv.php">Exportar CSV</a>
                        <b>|</b>
                        <a href="cliente-json.php">Exportar JSON</a>
                        <b>|</b>
                        <a href="cliente-xsl.php">Exportar XML</a>
                    </div>
                </div>
            </div>
        </div>
