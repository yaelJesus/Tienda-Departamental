            ...
            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                ...
                <div class="navi">
                    ...
                    echo '
                        ...
                        <li class="active"><a href="#"><i class="fa fa-cog" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Venta</span></a></li>
            ...
            <div class="col-md-10 col-sm-11 display-table-cell v-align">
                ...
                <div class="user-dashboard">
                    <div class="container col-sm-12">
                            ...
                            <div class="col-md-11">
                                <div class="panel panel-primary">
                                    <div class="panel-heading" style="display: flex; align-items: center; flex-wrap: wrap;">
                                        <h2 class="text-center" style="flex-basis: 100%;">Ventas</h2>
                                        <div style="width: 100%;">
                                        <?php 
                                        echo "
                                            <button class='btn btn-success' type='button' onclick='window.location.href = `VentaAdd.php?user=$user`' style='margin-bottom: 10px';>Agregar</button>";
                                        ?>
                                    ...
                                    <table class="table table-hover" id="dev-table">
                                        ...
                                        <tbody>
                                            <?php
                                                include('conecta.php');
                                                $query = "SELECT v.idVenta, v.fecha, v.total, e.nombre FROM venta v JOIN empleado e ON v.idEmpleado = e.idEmpleado WHERE v.estatus = 1";
                                                ...
                                                while($row = mysqli_fetch_assoc($result)){
                                                    ...
                                                    <tr class='larger-row'>
                                                        ...
                                                        <td>".$row['nombre']."</td>
                                                        <td>
                                                            <form action='VentaEditar.php' method='post'>
                                                                <input type='hidden' name='editar' id='editar' value='".$row['idVenta']."'>
                                                        ...
                                                        <td>
                                                            <form action='VentaEliminar.php' method='post'>
                                                                <input type='hidden' name='borrar' value='".$row['idVenta']."'>
                                                                <input type='hidden' name='user' id='user' value='".$user."'>
                        ...
                        <a href="Venta-pdf.php">Exportar PDF</a>
                        <b>|</b>
                        <a href="Venta-excel.php">Exportar EXEL</a>
                        <b>|</b>
                        <a href="Venta-csv.php">Exportar CSV</a>
                        <b>|</b>
                        <a href="Venta-json.php">Exportar JSON</a>
                        <b>|</b>
                        <a href="Venta-xsl.php">Exportar XML</a>
                    </div>
                </div>
            </div>
        </div>
