            ...
            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                ...
                <div class="navi">
                    ...
                    echo '
                        ...
                        <li class="active"><a href="#"><i class="fa fa-cog" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Producto</span></a></li>
            ...
            <div class="col-md-10 col-sm-11 display-table-cell v-align">
                ...
                <div class="user-dashboard">
                    <div class="container col-sm-12">
                            ...
                            <div class="col-md-11">
                                <div class="panel panel-primary">
                                    <div class="panel-heading" style="display: flex; align-items: center; flex-wrap: wrap;">
                                        <h2 class="text-center" style="flex-basis: 100%;">Producto</h2>
                                        <div style="width: 100%;">
                                        <?php 
                                        echo "
                                            <button class='btn btn-success' type='button' onclick='window.location.href = `ProductoAdd.php?user=$user`' style='margin-bottom: 10px';>Agregar</button>";
                                        ?>
                                                    ...
                                                    <tr class='larger-row'>
                                                        ...
                                                        <td>
                                                            <form action='ProductoEditar.php' method='post'>
                                                                <input type='hidden' name='editar' id='editar' value='".$row['idProducto']."'>
                                                        ...
                                                        <td>
                                                            <form action='ProductoEliminar.php' method='post'>
                                                                <input type='hidden' name='borrar' value='".$row['idProducto']."'>
                                                                <input type='hidden' name='user' id='user' value='".$user."'>
                        ...
                        <a href="Producto-pdf.php">Exportar PDF</a>
                        <b>|</b>
                        <a href="Producto-excel.php">Exportar EXCEL</a>
                        <b>|</b>
                        <a href="Producto-csv.php">Exportar CSV</a>
                        <b>|</b>
                        <a href="Producto-json.php">Exportar JSON</a>
                        <b>|</b>
                        <a href="Producto-xsl.php">Exportar XML</a>
                    </div>
                </div>
            </div>
        </div>
